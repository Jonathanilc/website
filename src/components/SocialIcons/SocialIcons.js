...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/Jonathanilc" style={{ color: colorPrimary }}><i className="fab fa-github"></i></a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/jonathan.xu.397" style={{ color: colorPrimary }}><i className="fab fa-facebook"></i></a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/jonathan-xu-4aba55115/" style={{ color: colorPrimary }}><i className="fab fa-linkedin"></i></a>
      <a target="_blank" rel="noopener noreferrer" style={{ color: colorPrimary }}><i className="fab fa-twitter"></i></a>
      {/* <a target="_blank" rel="noopener noreferrer" style={{ color: colorPrimary }}><i className="fab fa-stack-overflow"></i></a> */}
      <a target="_blank" rel="noopener noreferrer" style={{ color: colorPrimary }}><i className="fab fa-medium"></i></a>
      <a className="devto" target="_blank" rel="noopener noreferrer" >
